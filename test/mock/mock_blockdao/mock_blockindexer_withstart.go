...
func (m *MockBlockIndexerWithStart) Name() string {
	m.ctrl.T.Helper()
...
func (mr *MockBlockIndexerWithStartMockRecorder) Name() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Name", reflect.TypeOf((*MockBlockIndexerWithStart)(nil).Name))
}
